...
class Blockchain:
    ...
    def _initialize_genesis_block(self, genesis_block: Optional[Block]) -> None:
        ...
        if genesis_block is None:
            genesis_block = self._build_default_genesis_block()
            self.logger.info("No genesis block provided - created default genesis block")
    ...
    def _build_default_genesis_block(self) -> Block:
        """Build the legacy default genesis block expected by V1 tests."""
        return Block(
            index=0,
