#!/usr/bin/env python3
"""
EZchain Blockchain Persistence Demo (Fixed Version)
"""
...
def main():
    ...
    demo_dir = "blockchain_demo_fixed"
    ...
    if len(blocks_added) >= 4:
        ...
        if recovered_block:
            ...
            print(f"  Bloom filter test: {recovered_block.is_in_bloom('transaction_4_1')}")
        else:
            print(f"Block #{original_block.get_index()} not found")
    print()
